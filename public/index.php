...
<body>
    ...
    <main>
        <div class="maincontent">
            <img class="imagemlogo" src="./public/img/logo.png" alt="">
            <h1 class="primary-text">Malhar é questão de saúde física e mental</h1>
            <h2 class="second-text">
                SE INSCREVA AGORA E MUDE DE VIDA
            </h2>
            <div class="btns">
                <button class="plan"><a href="../public/plano.html">Planos</a></button>
                <button class="personal"><a href="../public/cadastro.php">Cadastre-se</a></button>
                <button class="imc"><a href="../public/imc.php">Calcule seu IMC</a></button>
